    ...
    <section className={`relative w-full min-h-screen overflow-hidden bg-background flex items-center justify-center ${className}`}>
      ...
      <div className={`relative z-10 ${maxWidth} mx-auto px-6 w-full`}>
        <div className="text-center">
          ...
          >
            <span style={{ color: 'white' }}>{title}</span> <Highlight className="text-[#00403d] bg-[#d9ff00]">{highlightText}</Highlight>
          </h1>
          ...
          <button
            ...
            className={`px-6 py-4 sm:px-8 sm:py-6 rounded-full bg-transparent backdrop-blur-sm text-sm sm:text-base text-white hover:backdrop-blur-md transition-all duration-300 relative overflow-hidden group ${buttonClassName}`}
            style={{ 
              backgroundColor: 'rgba(255, 255, 255, 0.05)',
              border: 'none',
              boxShadow: 'inset 0 0 0 1px rgba(255, 255, 255, 0.1), 0 0 20px rgba(217, 255, 0, 0.3)'
            }}
          >
            ...
            <div 
              ...
              style={{
                background: 'radial-gradient(circle, rgba(217, 255, 0, 0.2) 0%, transparent 70%)',
